...
public final class TemplateUtil {
	...
	public static String getJavaPartialManyToManyOwnerTemplate() {
		return getTemplate(JAVA_ANNOTATION_M2M_OWNER);
	}

	public static String getJavaPartialManyToManyOwnedTemplate() {
		return getTemplate(JAVA_ANNOTATION_M2M_OWNED);
	}
